...
CRCBS.heuristic(env::LowLevelEnv,s) = env.dists[s.stage][s.vtx]
...
"""
function CRCBS.initialize_root_node(mapf::MultiMAPF)
    ConstraintTreeNode(
...
"""
    `default_solution(solver::CBS_Solver)`
...
#     return default_solution(solver)
# end
